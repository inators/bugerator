...
<!-- if we come through the administration tab in the app we are double-diving so undiv a couple before rediving.-->
		...
		?>
    	    ...
    	    <a class="nav-tab<?PHP echo "$class $nav_tab";?>" 
    	       ...
    	       href="?page=bugerator_menu&tab=<?PHP echo $tab; ?>" >
                <?PHP else: 
                echo "href='$page&bugerator_nav=admin&project=$project&active_tab=$tab&tab=$tab' >";
		   endif; echo $name; ?></a>      
	    <?PHP endforeach; ?>
	</h2>
		...
		?>
            ...
            <?PHP if (!isset($post->ID)): // this is from the dashboard ?>
    	       href="?page=bugerator_menu&tab=change_css&subtab=<?PHP echo $sub; ?>" >
                <?PHP else: 
                echo "href='$page&bugerator_nav=admin&project=$project&active_tab=change_css&subtab=$sub' >";
