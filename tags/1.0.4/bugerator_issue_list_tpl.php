...
<script type="text/javascript" >
	...
	for (var x in elements) {
		...
		elements[x].className = "bugerator bugerator_list ";
	    }
	}
	document.getElementById("show_completed").style.display = "none";
    }
...
<span class="issue_list" >
    <a onclick="show_completed()" id="show_completed" >Show hidden</a>
<?PHP if ($is_admin): ?>
