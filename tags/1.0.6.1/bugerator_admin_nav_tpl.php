...
// $active_tab needs to be assigned too which is the $_GET call
		...
		if ($tab == "change_css")
			...
			$proper_admin_url."&bugerator_nav=admin&project=1&issue=3&active_tab=change_css'>$name</a>\r\n";
		elseif ("db" == $tab)
		    echo "	<li class='bug_admin_tab $class' id=li$tab ><a href='".
			$proper_admin_url."&bugerator_nav=admin&project=1&issue=3&active_tab=db'>$name</a>\r\n";
		else
