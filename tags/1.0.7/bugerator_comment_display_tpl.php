...
<br/>
    ...
    <?PHP
    if ($im_an_admin === true)
        echo "<a href='$post->guid&bugerator_nav=comment&project=$project_id&issue=$issue_id&comment_delete=$comment->id' style='text-align: center;' >Delete</a>";
        echo "<div class='admin_edit' style='float:right;' >\r\n" .
	"<a href='$post->guid&bugerator_nav=comment&project=$project_id&issue=$issue_id&comment_edit=$comment->id' >Edit</a>" .
	"</div>";
    ?>
