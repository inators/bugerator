...
<tr><td colspan="5" style="border: none;">&nbsp;</td></tr>
	...
	<th class="bugerator bugerator_map" colspan ="2" style="width: 40%;" >
	    ...
	    Anticipated release date: <?PHP if ($goal_list[$x]>1)
	    echo date($date_format,strtotime($goal_list[$x])); ?>
	    <?PHP else: ?>
	    Release date: <?PHP if ($goal_list[$x]>1)
		echo date($date_format,strtotime($goal_list[$x])); ?>
	    <?PHP endif; ?>
	</th>
    </tr>
...
<table class="bugerator bugerator_map" >
	...
	<td class="bugerator bugerator_map" >
	    ...
	    echo $post->guid;?>&bugerator_nav=display&bug_project=<?PHP echo $project;?>&issue=<?PHP 
