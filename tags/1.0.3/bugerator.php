...
function show_file_$type" . "_$id() {
    ...
    function process_project_edit($project_id, $result) {
		...
		$goal_array[$current_version-1] = date("Y-m-d", time());
	}
    ...
    function admin_db_import() {
        ...
        // so the users
        if (!isset($_POST['import_nonce']) or
                false == wp_verify_nonce($_POST['import_nonce'], 'bugerator_addusers')) {
